      ...
      <div className="max-w-md w-full z-10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-blue-600 p-6 text-center relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold text-white relative z-10">Register</h2>
            <p className="text-blue-100 mt-1 relative z-10">Create your account to get started</p>
          </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={formData.role}
                      onChange={handleChange}
                      className="block w-full px-3 py-3 border border-gray-300 rounded-lg text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                    >
