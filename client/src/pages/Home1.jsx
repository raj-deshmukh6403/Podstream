...
const HomePage = () => {
  ...
  const testimonials = [
    {
      ...
      name: 'Jessica K.',
      role: 'Daily Commuter',
      text: 'PodWave has completely transformed my daily commute. The recommendations are spot on, and I discover new shows I love every week!',
    ...
    },
    {
      ...
      text: 'As a creator, the analytics and audience insights have been invaluable. My subscriber count has doubled since joining PodWave.',
      avatar: '/api/placeholder/60/60'
    },
    {
      id: 3,
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-blue-50">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-xl font-semibold text-blue-800">Loading PodWave...</h2>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-blue-50 text-blue-900 pb-20">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <div className="text-blue-600 font-bold text-2xl">PodWave</div>
              ...
              <div className="hidden md:block ml-10">
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className={`px-3 py-2 rounded-md text-sm font-medium ${activePage === 'home' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                  ...
                  <a 
                    href="#" 
                    className={`px-3 py-2 rounded-md text-sm font-medium ${activePage === 'discover' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                  ...
                  <a 
                    href="#" 
                    className={`px-3 py-2 rounded-md text-sm font-medium ${activePage === 'library' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                  ...
                  <a 
                    href="#" 
                    className={`px-3 py-2 rounded-md text-sm font-medium ${activePage === 'creators' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
              ...
              <div className="flex items-center">
                <div className="relative mx-4">
                  <input
                    ...
                    className="bg-blue-50 text-blue-900 px-4 py-2 pl-10 pr-4 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-64"
                  />
                  <div className="absolute left-3 top-2.5 text-blue-400">🔍</div>
                </div>
                <button className="bg-blue-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-600 transition">
                  Log In
                </button>
                <button className="ml-2 bg-white text-blue-600 border border-blue-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-50 transition">
                  Sign Up
                </button>
              </div>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a 
                href="#" 
                className={`block px-3 py-2 rounded-md text-base font-medium ${activePage === 'home' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                onClick={() => {
                  setActivePage('home');
              ...
              <a 
                href="#" 
                className={`block px-3 py-2 rounded-md text-base font-medium ${activePage === 'discover' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                onClick={() => {
              ...
              <a 
                href="#" 
                className={`block px-3 py-2 rounded-md text-base font-medium ${activePage === 'library' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                onClick={() => {
              ...
              <a 
                href="#" 
                className={`block px-3 py-2 rounded-md text-base font-medium ${activePage === 'creators' ? 'bg-blue-100 text-blue-700' : 'text-blue-500 hover:bg-blue-50'}`}
                onClick={() => {
              ...
              <div className="relative mt-3">
                <input
                  type="text"
                  placeholder="Search podcasts..."
                  className="bg-blue-50 text-blue-900 px-4 py-2 pl-10 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
                />
                <div className="absolute left-3 top-2.5 text-blue-400">🔍</div>
              </div>
              <div className="mt-4 flex space-x-2">
                <button className="bg-blue-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-600 transition w-1/2">
                  Log In
                </button>
                <button className="bg-white text-blue-600 border border-blue-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-50 transition w-1/2">
                  Sign Up
                </button>
              </div>
            </div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center">How PodWave Works</h2>
      ...
      <section className="py-16 px-6 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto md:flex items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Take PodWave With You</h2>
            <p className="text-xl text-blue-200 mb-8">Download our mobile app for iOS and Android to listen on the go.</p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="bg-white text-blue-900 px-6 py-3 rounded-lg font-medium hover:bg-blue-100 transition flex items-center justify-center">
          ...
          <div className="md:w-1/2 flex justify-center">
            <img src="/api/placeholder/300/600" alt="Mobile App" className="rounded-xl shadow-2xl h-64 md:h-auto" />
          </div>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-blue-800 text-white pt-16 pb-8 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              <div className="flex items-center mb-6">
                <div className="text-white font-bold text-2xl">PodWave</div>
                <div className="ml-2 text-blue-300">📻</div>
              </div>
              <p className="text-blue-200 mb-6">Your premier destination for podcasts across all genres and topics.</p>
              <div className="flex space-x-4">
                <a href="#" className="bg-blue-700 hover:bg-blue-600 w-10 h-10 rounded-full flex items-center justify-center transition">
                  <span>📱</span>
                </a>
                <a href="#" className="bg-blue-700 hover:bg-blue-600 w-10 h-10 rounded-full flex items-center justify-center transition">
                  <span>💻</span>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-blue-200 hover:text-white transition">Discover</a></li>
                <li><a href="#" className="text-blue-200 hover:text-white transition">Categories</a></li>
                <li><a href="#" className="text-blue-200 hover:text-white transition">Top Charts</a></li>
                <li><a href="#" className="text-blue-200 hover:text-white transition">For Creators</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-blue-200">123 Podcast Lane<br />San Francisco, CA 94107</span>
                </li>
                ...
                <li className="flex items-center">
                  <span className="mr-2">📧</span>
                  <span className="text-blue-200">hello@podwave.com</span>
                </li>
              </ul>
            </div>
          </div>
          
          <div className="mt-16 pt-8 border-t border-blue-700 text-center text-blue-300">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-blue-100 py-3 px-4 shadow-lg z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <img src="/api/placeholder/60/60" alt="Current Podcast" className="w-12 h-12 rounded mr-3" />
            <div>
              <h4 className="font-medium text-sm">The Future of AI</h4>
              <p className="text-xs text-blue-600">Tech Today</p>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-md mx-8 hidden md:block">
            <div className="flex flex-col items-center">
              <div className="flex items-center space-x-4 mb-1">
                <button className="text-blue-400 hover:text-blue-600 transition">⏮️</button>
                <button 
                  className={`${isPlaying ? 'bg-blue-600' : 'bg-blue-500'} rounded-full w-8 h-8 flex items-center justify-center text-white hover:bg-blue-600 transition`}
                  onClick={togglePlay}
                >
                  {isPlaying ? '⏸' : '▶'}
                </button>
              ...
              <div className="w-full flex items-center space-x-2">
                <span className="text-xs text-blue-500">12:34</span>
                <input 
                  type="range" 
                  min="0" 
                  max="100" 
                  ...
                  className="w-full h-1 appearance-none bg-blue-200 rounded-full outline-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-600"
                />
                <span className="text-xs text-blue-500">45:21</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden sm:flex items-center space-x-2">
              <button className="text-blue-400 hover:text-blue-600 transition">🔁</button>
              <input 
                type="range" 
                min="0" 
                max="100" 
                ...
                className="w-20 h-1 appearance-none bg-blue-200 rounded-full outline-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-600"
              />
              <button className="text-blue-400 hover:text-blue-600 transition">🔊</button>
            </div>
            <button className="md:hidden bg-blue-500 rounded-full w-8 h-8 flex items-center justify-center text-white hover:bg-blue-600 transition">
              {isPlaying ? '⏸' : '▶'}
            </button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg max-w-3xl w-full max-h-[80vh] overflow-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-blue-800">Explore PodWave</h3>
                <button 
